    ...
    private fun fetchAnnouncements() {
        lifecycleScope.launch {
            try {
                ...
                Toast.makeText(this@ManageAnnouncementsActivity, getString(R.string.error_fetching_announcements, e.localizedMessage), Toast.LENGTH_SHORT).show()
            }
        }
    }
    ...
    private fun deleteAnnouncement(announcement: Announcement) {
        lifecycleScope.launch {
            try {
                ...
                Toast.makeText(this@ManageAnnouncementsActivity, getString(R.string.announcement_deleted), Toast.LENGTH_SHORT).show()
                fetchAnnouncements()
            } catch (e: Exception) {
                Toast.makeText(this@ManageAnnouncementsActivity, getString(R.string.error_delete_announcement, e.localizedMessage), Toast.LENGTH_SHORT).show()
            }
        }
    }
}
