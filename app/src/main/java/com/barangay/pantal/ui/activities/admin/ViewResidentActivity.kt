        ...
        lifecycleScope.launch {
            try {
                ...
                currentResident?.let { res ->
                    ...
                    binding.detailsTextView.text = "Age: ${res.age} | Gender: ${res.gender}"
                    binding.addressTextView.text = "Address: ${res.address}"
                    binding.occupationTextView.text = "Occupation: ${res.occupation}"
