...
import com.barangay.pantal.ui.activities.user.UserReportsActivity
...
open class BaseActivity : AppCompatActivity() {
    ...
    fun setupBottomNavigation(navView: BottomNavigationView, selectedItemId: Int) {
        ...
        navView.setOnItemSelectedListener { item ->
            ...
            val targetActivity = when (item.itemId) {
                ...
                R.id.action_reports -> when (userRole) {
                    "admin" -> ReportsActivity::class.java
                    "staff" -> com.barangay.pantal.ui.activities.staff.StaffReportsActivity::class.java
                    else -> UserReportsActivity::class.java
                }
                else -> null
            }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        val targetActivity = when (item.itemId) {
            ...
            R.id.navigation_staff_management -> StaffManagementActivity::class.java
            R.id.action_reports -> when (getUserRole().lowercase(Locale.getDefault())) {
                "admin" -> ReportsActivity::class.java
                "staff" -> com.barangay.pantal.ui.activities.staff.StaffReportsActivity::class.java
                else -> UserReportsActivity::class.java
            }
